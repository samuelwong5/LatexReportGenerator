...
The total number of security events in QUARTER increased dramatically by 99\% or 10 851 events, reached a record high since Q2 2013. The increase was due to server events.
...
\begin{figure}[h!]
\centerline{\includegraphics[__PIE_CHART__]{BotnetFamPie}}
...
\clearpage
\begin{figure}[h!]
\centerline{\includegraphics[height=10cm]{BotnetFamTopLine}}
