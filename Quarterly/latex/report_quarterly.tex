...
infected and controlled by malicious software.    
...
\begin{table}[h!]
     ...
     \begin{tabular}{ c p{14cm} }
     \toprule
     \multirow{4}{*}{\raisebox{-\totalheight}{\includegraphics[width=0.1\textwidth ,height=3cm]{warning}}} & What is defacement? \\\cline{2-2} 
                            & \begin{itemize}[topsep=0pt]
...
\begin{table}[h!]
     ...
     \begin{tabular}{ c p{14cm} }
     \toprule
     \multirow{4}{*}{\raisebox{-\totalheight}{\includegraphics[width=0.1\textwidth ,height=3cm]{warning}}} & What is URL/IP ratio? \\\cline{2-2} 
                            & \begin{itemize}[topsep=0pt]
...
\begin{table}[h!]
     ...
     \begin{tabular}{ c p{14cm} }
     \toprule
     \multirow{4}{*}{\raisebox{-\totalheight}{\includegraphics[width=0.1\textwidth ,height=3cm]{warning}}} & What is Phishing? \\\cline{2-2} 
                            & \begin{itemize}[topsep=0pt]
...
\begin{table}[h!]
     ...
     \begin{tabular}{ c p{14cm} }
     \toprule
     \multirow{4}{*}{\raisebox{-\totalheight}{\includegraphics[width=0.1\textwidth ,height=3cm]{warning}}} & What is Malware Hosting? \\\cline{2-2} 
                            & \begin{itemize}[topsep=0pt]
...
\begin{table}[h!]
     ...
     \begin{tabular}{ c p{14cm} }
     \toprule
     \multirow{4}{*}{\raisebox{-\totalheight}{\includegraphics[width=0.1\textwidth ,height=3cm]{warning}}} & What is a Botnet Command \& Control Center? \\\cline{2-2} 
                            & \begin{itemize}[topsep=0pt]
...
\begin{figure}[h!]
\centerline{\includegraphics[height=12cm]{placeholder}}
...
\begin{table}[h!]
     ...
     \begin{tabular}{ c p{14cm} }
     \toprule
     \multirow{4}{*}{\raisebox{-\totalheight}{\includegraphics[width=0.1\textwidth ,height=3cm]{warning}}} & What is a Botnet - Bot? \\\cline{2-2} 
                            & \begin{itemize}[topsep=0pt]
